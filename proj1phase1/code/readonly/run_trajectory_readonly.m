...
while (1)
    ...
    num_int = num_int+1;
    RMSE_pos = RMSE_pos+(true_s(1:3) - des_s(1:3)).^2; 
    RMSE_vel = RMSE_vel+(true_s(4:6) - des_s(4:6)).^2;
    RMSE_ang_vel = RMSE_ang_vel+(true_s(11:13) - des_s(11:13)).^2;
...
disp(sqrt(RMSE_pos/num_int));
disp(sqrt(RMSE_vel/num_int));
disp(sqrt(RMSE_ang_vel/num_int));
