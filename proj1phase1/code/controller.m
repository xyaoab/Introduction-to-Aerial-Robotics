...
%tuning parameters
% kp_pos = [15 15 30];%[7 7 50];%[4 6 190];
% kd_pos = [12 12 10];%[4 4 80];%[7 6 100];
% kp_rpy = [3000 3000 3000];%[1000 1000 100];%[70 70 20];
% kd_rpy = [300 300 300];%[98 98 49];%[30 30 10];
kp_pos = [4 4 5];%[7 7 50];%[4 6 190];
kd_pos = [2.5 2.5 5];%[4 4 80];%[7 6 100];
kp_rpy = [100 100 75];%[1000 1000 100];%[70 70 20];
